fbq.version = "2.9.55", fbq._releaseSegment = "stable", fbq.pendingConfigs = ["global_config"], fbq.__openBridgeRollout = 1, function (e, t, n, r) {
    var s = {exports: {}};
    s.exports, function () {
        var r = e.fbq;
        if (r.execStart = e.performance && e.performance.now && e.performance.now(), function () {
            ...
            var i = function (e, t) {
                    ...
                    if (("function" == typeof Symbol ? Symbol.iterator : "@@iterator") in Object(e)) return function (e, t) {
                        ...
                        try {
                            var o;
                            for (e = e["function" == typeof Symbol ? Symbol.iterator : "@@iterator"](); !(r = (o = e.next()).done) && (n.push(o.value), !t || n.length !== t); r = !0) ;
                        } catch (e) {
                            s = !0, i = e
                        } finally {
                            try {
            ...
            r.__fbeventsModules || (r.__fbeventsModules = {}, r.__fbeventsResolvedModules = {}, r.getFbeventsModules = function (e) {
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsLogging"), t = e.logUserError,
                            n = /^[+-]?\d+(\.\d+)?$/, s = "number", o = "currency_code", a = {
                                AED: 1,
                                ARS: 1,
                                AUD: 1,
                                BOB: 1,
                                ...
                                Subscribe: {},
                                ViewContent: {}
                            }, l = {agent: !0, automaticmatchingconfig: !0, codeless: !0, tracksingleonly: !0},
                        ...
                        function f(e) {
                            ...
                            var n = u[e];
                            return n ? p(e, t, n) : g([{eventName: e, type: "NONSTANDARD_EVENT"}])
                        }

                        function p(e, t, r) {
                            r = r.validationSchema;
                            var i = [];
                            for (var u in r) if (c.call(r, u)) {
                                var l = r[u], f = t[u];
                                if (l) {
                                    ...
                                    if (null != l.type && "string" == typeof l.type) {
                                        ...
                                        if (!p) return d({eventName: e, param: u, type: "INVALID_PARAM"})
                                    }
                                }
                            }
                            return g(i)
                        ...
                        i.exports = {
                            validateEvent: f, validateEventAndLog: function (e, n) {
                                if ((e = f(e, n)).error && t(e.error), e.warnings) for (n = 0; n < e.warnings.length; n++) t(e.warnings[n]);
                                return e
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsUtils"), t = e.map, n = e.keys;
                        e = function () {
                            function e(t) {
                            ...
                            return o(e, [{
                                key: "listen", value: function (e) {
                                    var t = this, n = "" + this._regKey++;
                                    return this._subscriptions[n] = e, function () {
                                        delete t._subscriptions[n]
                                    }
                                }
                            }, {
                                key: "listenOnce", value: function (e) {
                                    var t = null;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var a = function () {
                            ...
                            return o(t, [{
                                key: "addToBatch", value: function (t) {
                                    var r = this;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsTyped"), t = e.coerce,
                            n = (e = e.Typed).objectWithFields({selectedMatchKeys: e.arrayOf(e.string())});
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsTyped"), t = e.Typed, n = e.coerce, s = e.enforce,
                            o = function (e) {
                                ...
                                } : s(e, t.objectWithFields({batchWaitTimeMs: t.number(), maxBatchSize: t.number()}))
                            };
                        i.exports = function (e) {
                            return n(e, o)
                        }
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsUtils"), t = e.filter, n = e.map,
                        ...
                        function l(e) {
                            ...
                            if (e = e.parameter_selectors, Array.isArray(e)) {
                                e = n(e, u);
                                var r = t(e, Boolean);
                                if (e.length === r.length) return {parameter_selectors: r}
                            }
                            return null
                        }
                        ...
                        function c(e) {
                            if (null == e || "object" !== (void 0 === e ? "undefined" : a(e))) return null;
                            if (null == (e = e.extractor_config) || "object" !== (void 0 === e ? "undefined" : a(e))) return null;
                            var t = e.context, n = e.parameter_type;
                        ...
                        i.exports = function (e) {
                            var t = function (e) {
                                if (null == e || "object" !== (void 0 === e ? "undefined" : a(e))) return null;
                                var t = e.domain_uri, n = e.event_type, r = e.extractor_type;
                            ...
                            var n = t.domain_uri, r = t.event_type, s = t.extractor_type;
                            if (t = t.id, "CSS" === s) {
                                var i = l(e);
                                if (null != i) return {
                                    domain_uri: n,
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsLogging"), t = e.logUserError,
                            n = (e = r.getFbeventsModules("SignalsFBEventsTyped")).Typed, s = e.coerce;
                        i.exports = function (e) {
                            if (null == (e = s(e, n.fbid()))) {
                                var r = JSON.stringify(e);
                                return t({pixelID: null != r ? r : "undefined", type: "INVALID_PIXEL_ID"}), null
                            }
                            return e
                        }
                    }(), i.exports
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var e = Object.assign || function (e) {
                            ...
                            return e
                        }, t = r.getFbeventsModules("SignalsFBEventsUtils"), n = t.filter, s = t.map, o = t.reduce;
                        ...
                        i.exports = {
                            coerceArray: c, coerceArrayFilteringNulls: d, coerceArrayOf: function (e, t) {
                                var n = c(e);
                            ...
                            }, coerceObject: u, coerceObjectWithFields: function (t, n) {
                                var r = u(t);
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var e = r.getFbeventsModules("SignalsFBEventsQE"),
                            ...
                            u = r.getFbeventsModules("SignalsFBEventsTyped"), l = u.coerce, c = u.Typed;
                        ...
                        var g = r.getFbeventsModules("SignalsFBEventsParallelFireConfigTypedef"),
                            ...
                            h = r.getFbeventsModules("SignalsFBEventsLogging"), y = h.logError, _ = "global", F = {
                                automaticMatching: E,
                                openbridge: u,
                                batching: v,
                                inferredEvents: b,
                        ...
                        h = function () {
                            ...
                            return o(t, [{
                                ...
                                key: "setExperimental", value: function (t) {
                                    if (null != (t = l(t, c.objectWithFields({
                                        ...
                                        var n = t.config, r = t.experimentName, s = t.pixelID;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsTyped"), t = e.Typed;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var s = Object.assign || function (e) {
                            ...
                            l = r.getFbeventsModules("SignalsFBEventsEvents"), g = l.configLoaded,
                        ...
                        var v = r.getFbeventsModules("SignalsFBEventsOptIn"),
                            ...
                            m = r.getFbeventsModules("SignalsFBEventsURLUtil"), h = m.getURLParameter,
                            y = (m = r.getFbeventsModules("SignalsPixelCookieUtils")).CLICK_ID_PARAMETER,
                            _ = m.readPackedCookie, F = m.CLICKTHROUGH_COOKIE_NAME,
                            S = (m = r.getFbeventsModules("SignalsFBEventsExperimentNames")).USE_FBC_AS_CACHE_KEY_EXPERIMENT,
                            x = r.getFbeventsModules("SignalsFBEventsQE"), M = r.getFbeventsModules("SignalsParamList"),
                            I = r.getFbeventsModules("signalsFBEventsSendEvent"), B = E.each, P = E.keys, O = E.map,
                            T = E.some, w = l.logError, A = l.logUserError, N = {
                                AutomaticMatching: !0,
                                ...
                                IABPCMAEBridge: !0,
                                AEM: !0
                            }, C = 1, k = 2, R = 3, D = {AutomaticSetup: m = ["InferredEvents", "Microdata"]}, L = {
                        ...
                        E = function () {
                            ...
                            return o(r, [{
                                ...
                                key: "optOut", value: function (e, t) {
                                    return this.optIns.optOut(e, t), this
                                }
                            }, {
                                key: "consent", value: function (e) {
                                ...
                                key: "setUserProperties", value: function (e, t) {
                                ...
                                key: "trackSingle", value: function (e, t, n, r) {
                                    return a.validateEventAndLog(t, n), this.trackSingleGeneric(e, t, n, C, r)
                                }
                            }, {
                                key: "trackSingleCustom", value: function (e, t, n, r) {
                                    return this.trackSingleGeneric(e, t, n, k, r)
                                }
                            }, {
                                key: "trackSingleSystem", value: function (e, t, n, r) {
                                    return this.trackSingleGeneric(t, n, r, R, null, e)
                                }
                            }, {
                                key: "trackSingleGeneric", value: function (e, t, n, r, i, o) {
                                    if (e = "string" == typeof e ? e : e.id, !Object.prototype.hasOwnProperty.call(this.pixelsByID, e)) {
                                        var a = {pixelID: e, type: "PIXEL_NOT_INITIALIZED"};
                                        return null == o ? A(a) : w(new Error(a.type + " " + a.pixelID)), this
                                    }
                                    return (a = this.getDefaultSendData(e, t, i)).customData = n, null != o && (a.customParameters = {es: o}), a.customParameters = s({}, a.customParameters, {tm: "" + r}), this.fire(a, !1), this
                                }
                            }, {
                                key: "_validateSend", value: function (e, t) {
                                ...
                                key: "_argsHasAnyUserData", value: function (e) {
                                ...
                                key: "callMethod", value: function (e) {
                                    var t = e[0];
                                    if (e = Array.prototype.slice.call(e, 1), "string" == typeof t) if ("function" == typeof this[t]) try {
                                        this[t].apply(this, e)
                                    } catch (e) {
                                        w(e)
                                    } else A({
                                    ...
                                    }); else A({type: "FBQ_NO_METHOD_NAME"})
                                }
                            }, {
                                key: "getDefaultSendData", value: function (e, t, n) {
                                    var r = this.getPixel(e);
                                    return n = {
                                        eventData: n || {},
                                        eventName: t,
                                        pixelId: e
                                    }, r && (r.userData && (n.userData = r.userData), null != r.agent && "" !== r.agent ? n.set = {agent: r.agent} : null != this.fbq.agent && "" !== this.fbq.agent && (n.set = {agent: this.fbq.agent})), n
                                }
                            }, {
                                key: "getOptedInPixels", value: function (e) {
                                    var t = this;
                                ...
                                key: "getPixel", value: function (e) {
                                    return this.pixelsByID[e]
                                }
                            }, {
                                key: "getFBCWithAEMPayload", value: function () {
                                ...
                                key: "loadConfig", value: function (r) {
                                ...
                                key: "configLoaded", value: function (e) {
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsUtils"), t = e.each, n = e.keys;
                        (e = function () {
                            function e() {
                            ...
                            return o(e, [{
                                ...
                                key: "onUnlocked", value: function (e) {
                                ...
                                key: "lockPlugin", value: function (e) {
                                    this.lock("plugin:" + e)
                                }
                            }, {
                                key: "releasePlugin", value: function (e) {
                                    this.release("plugin:" + e)
                                }
                            }, {
                                key: "lockConfig", value: function (e) {
                                    this.lock("config:" + e)
                                }
                            }, {
                                key: "releaseConfig", value: function (e) {
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var e = r.getFbeventsModules("SignalsFBEventsBaseEvent"),
                            ...
                            n = r.getFbeventsModules("SignalsFBEventsTyped"), s = n.Typed, o = n.coerce;
                ...
                return function (e, t, n, r) {
                    ...
                    return s.exports, function () {
                        "use strict";
                        var t = function () {
                            var t = e.chrome, n = e.navigator, r = n.vendor, s = void 0 !== e.opr,
                ...
                return function (e, t, n, r) {
                    ...
                    return s.exports, function () {
                        "use strict";
                        var t = function () {
                            var t = e.navigator, n = t.userAgent.indexOf("AppleWebKit"),
                                r = t.userAgent.indexOf("FBIOS"), s = t.userAgent.indexOf("Instagram");
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        i.exports = new e((function () {
                            ...
                            var u = o.unsafePixel, l = o.unsafeTarget, c = s(u, n), d = l instanceof Node ? t(l) : null;
                            return null != c && null != d ? [{pixel: c, target: d}] : null
                        }))
                    }(), i.exports
                }()
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        e = new e((function () {
                            ...
                            var i = s.graphToken, o = s.pixelID, u = t(o);
                            return null != i && "string" == typeof i && null != u ? [{graphToken: i, pixelID: u}] : null
                        })), i.exports = e
                    }(), i.exports
                }()
                ...
                return function (e, t, n, r) {
                    ...
                    return s.exports, function () {
                        "use strict";
                        var e = {CDN_BASE_URL: "https://connect.facebook.net/"};
                        ...
                        s.exports = {
                            CONFIG: e, loadJSFile: function (e) {
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        function s(e) {
                            var t = e.name, n = e.code, r = e.range;
                            return e = e.passRate, {allocation: r[1] - r[0], code: n, name: t, passRate: e}
                        }
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var t = r.getFbeventsModules("SignalsFBEventsUtils"), n = t.isArray, s = t.isInstanceOf,
                            o = t.map, a = r.getFbeventsModules("SignalsParamList"),
                            u = r.getFbeventsModules("signalsFBEventsSendGET"),
                            l = r.getFbeventsModules("SignalsFBEventsJSLoader"), c = !1;
                        var d = !0;
                        var g = !1;
                        var f = "console", p = "warn", v = [];
                        ...
                        t = {
                            consoleWarn: E, disableAllLogging: function () {
                                b = !0
                            }, disableSampling: function () {
                                d = !1
                            }, enableVerboseDebugLogging: function () {
                                c = !0
                            }, logError: S, logUserError: function (t) {
                                ...
                                Object.prototype.hasOwnProperty.call(h, n) || (h[n] = !0, m(n = function (e) {
                                    switch (e.type) {
                                        ...
                                        case"INVALID_FBQ_METHOD_PARAMETER":
                                            ...
                                            var n = e.invalidParamValue, r = e.method, s = e.params;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var t = r.getFbeventsModules("SignalsFBEventsTelemetry"),
                            n = r.getFbeventsModules("SignalsFBEventsUtils").each, s = {
                            ...
                            pixelHasActiveBridge: function (e) {
                                ...
                                n(l(e), (function (n) {
                                    return n.sendEvent(e.id, function (e) {
                                        ...
                                        var t = {};
                                        if (null != e && "object" === (void 0 === e ? "undefined" : a(e))) for (var n in e) if (Object.prototype.hasOwnProperty.call(e, n)) {
                                            var r = d(e[n]);
                                            null != r && (t[c(n)] = r)
                                        }
                                        return t
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsUtils"), t = e.each, n = e.filter, s = e.keys,
                            a = e.some;
                        ...
                        e = function () {
                            ...
                            return o(e, [{
                                ...
                                key: "isOptedIn", value: function (e, t) {
                                    return null != this._opts[t] && !0 === this._opts[t][e]
                                }
                            }, {
                                key: "isOptedOut", value: function (e, t) {
                                    return null != this._opts[t] && !1 === this._opts[t][e]
                                }
                            }, {
                                key: "listPixelIds", value: function (e) {
                                    var t = this._opts[e];
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsTyped");
                        e = (e = e.Typed).objectWithFields({target: e.string()}), i.exports = e
                    }(), i.exports
                }()
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsTyped");
                        e = (e = e.Typed).objectWithFields({pcmInstagramTriggerAttributionURL: e.string()}), i.exports = e
                    }(), i.exports
                }()
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var e = r.getFbeventsModules("SignalsFBEventsBaseEvent"),
                            t = r.getFbeventsModules("SignalsFBEventsPixelTypedef"),
                            n = r.getFbeventsModules("SignalsFBEventsTyped"), s = n.coerce;
                        n = new e((function (e) {
                ...
                return function (e, t, n, s) {
                    ...
                    return a.exports, function () {
                        ...
                        var t = "fb", n = function () {
                            function n(e) {
                                d(this, n), "string" == typeof e ? this.maybeUpdatePayload(e) : (this.subdomainIndex = e.subdomainIndex, this.creationTime = e.creationTime, this.payload = e.payload)
                            }

                            return o(n, [{
                                key: "pack", value: function () {
                                    return [t, this.subdomainIndex, this.creationTime, this.payload].join(".")
                                }
                            }, {
                                key: "maybeUpdatePayload", value: function (e) {
                                    null !== this.payload && this.payload === e || (this.payload = e, e = Date.now(), this.creationTime = "number" == typeof e ? e : (new Date).getTime())
                                }
                            }], [{
                                key: "unpack", value: function (r) {
                                    try {
                                        if (4 !== (r = r.split(".")).length) return null;
                                        var s = i(r, 4), o = s[0], a = s[1], u = s[2];
                                        if (s = s[3], o !== t) throw new Error("Unexpected version number '" + r[0] + "'");
                                        ...
                                        return new n({creationTime: a, payload: s, subdomainIndex: o})
                                    } catch (t) {
                                        return e(t), null
                                    }
                                }
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var e = r.getFbeventsModules("SignalsFBEventsConfigStore"),
                            t = r.getFbeventsModules("SignalsFBEventsEvents"), n = t.pluginLoaded,
                        ...
                        t = function () {
                            ...
                            return o(t, [{
                                key: "registerPlugin", value: function (t, s) {
                                    Object.prototype.hasOwnProperty.call(this._loadedPlugins, t) || (this._loadedPlugins[t] = function (e, t) {
                                        ...
                                        return t = t.plugin, 1 !== n || "function" != typeof t ? (u(new Error("Invalid plugin registered " + e)), new l((function () {
                                        }))) : new l(t)
                                    }(t, s), this._loadedPlugins[t].plugin(r, this._instance, e), n.trigger(t), this._lock.releasePlugin(t))
                                }
                            }, {
                                key: "loadPlugin", value: function (e) {
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsTyped"), t = e.Typed;
                        e.coerce, e = t.objectWithFields({prohibitedSources: t.arrayOf(t.objectWithFields({domain: t.allowNull(t.string())}))}), i.exports = e
                    }(), i.exports
                }()
                ...
                return function (e, t, n, s) {
                    ...
                    return a.exports, function () {
                        ...
                        var e = r.getFbeventsModules("SignalsFBEventsExperimentsTypedef"),
                            ...
                            s = r.getFbeventsModules("SignalsFBEventsTyped"), u = s.coerce,
                            l = (s = r.getFbeventsModules("SignalsFBEventsUtils")).reduce, c = function () {
                                return Math.random()
                            };
                        s = function () {
                            function r() {
                            ...
                            return o(r, [{
                                key: "setExperiments", value: function (r) {
                                    ...
                                    if (!this._hasRolled) {
                                        ...
                                        null != (t = function (e) {
                                            for (var t = l(e, (function (e, t, n) {
                                                ...
                                                var s = e[r], o = s.passRate, a = s.code;
                                                s = s.name;
                                                var u = i(t[r], 2), d = u[0];
                                ...
                                key: "isInTestOrControl", value: function (e) {
                                    var t = this.get();
                                    return null != t && t.name === e
                                }
                            }, {
                                key: "isInTest", value: function (e) {
                                    var t = this.get();
                ...
                return function (e, t, n, r) {
                    ...
                    return s.exports, function () {
                        ...
                        s.exports = function (e) {
                            ...
                            return e = e.isLegacySyntax, {args: n = t(n), isLegacySyntax: e}
                        }
                    }(), s.exports
                }()
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var t = r.getFbeventsModules("SignalsFBEventsBatcher"),
                            n = r.getFbeventsModules("SignalsFBEventsLogging"), s = n.logError,
                        ...
                        var d = new t((function (e) {
                            e = o(e, (function (e) {
                                ...
                                batch: 1,
                                events: e
                            }), (e = l(e) || u(e) || c(e) || l(e, {ignoreRequestLengthCheck: !0})) || s(new Error("could not send batch"))
                        }));
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var s = r.getFbeventsModules("SignalsFBEventsEvents"), o = s.fired, a = s.setEventId,
                            u = r.getFbeventsModules("SignalsFBEventsQE"), l = r.getFbeventsModules("SignalsParamList"),
                            ...
                            _ = s.SEND_BEACON_STRING_EXPERIMENT, F = s.SEND_XHR_EXPERIMENT, S = e.top !== e;
                        ...
                        function M(r) {
                            var s = r.customData, i = r.customParams, o = r.eventName, a = r.id, c = r.piiTranslator,
                                d = r.documentLink, g = r.referrerLink, f = n.href;
                        ...
                        i.exports = function (e) {
                            ...
                            if (!h(t, (function (e) {
                                ...
                                t = e.customData;
                                var n = e.eventName, r = M(e);
                                if (a.trigger(e.id, r), u.isInTest(y)) return d(r), void o.trigger("BATCH", r, t);
                                if ((e = u.isInTestOrControl(_) || !E()) && "SubscribedButtonClick" === n && g(r)) o.trigger("BEACON", r, t); else if (f(r)) o.trigger("GET", r, t); else if (e && g(r)) o.trigger("BEACON", r, t); else {
                                    if (u.isInTest(F)) return p(r) ? void o.trigger("XHR", r, t) : (f(r, {ignoreRequestLengthCheck: !0}), void o.trigger("FGET", r, t));
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var n = r.getFbeventsModules("SignalsFBEventsTyped"), s = n.Typed;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        i.exports = function (r, i) {
                            ...
                            var o = "fb" + Math.random().toString().replace(".", ""), a = t.createElement("form");
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        i.exports = function (t, n) {
                            var r = n || {}, s = r.ignoreRequestLengthCheck;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var e = r.getFbeventsModules("SignalsFBEventsNetworkConfig"),
                            t = r.getFbeventsModules("SignalsParamList"),
                            n = r.getFbeventsModules("SignalsFBEventsLogging").logError, s = 4,
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var e = r.getFbeventsModules("SignalsFBEventsBaseEvent"),
                            t = r.getFbeventsModules("SignalsParamList"),
                            n = r.getFbeventsModules("SignalsFBEventsPixelTypedef"),
                            s = r.getFbeventsModules("SignalsFBEventsTyped"), o = s.coerce;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsBaseEvent"),
                            t = r.getFbeventsModules("SignalsFBEventsUtils"), n = t.filter, s = t.map,
                        ...
                        t = new e((function () {
                            ...
                            var l = i.pixelID, c = i.extractors, d = u(l), g = Array.isArray(c) ? s(c, o) : null,
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        var a = Math.random(), u = e.fbq && e.fbq._releaseSegment ? e.fbq._releaseSegment : "unknown",
                            l = a < o || "canary" === u, c = "https://connect.facebook.net/log/fbevents_telemetry/";
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        ...
                        t.filter, t.map;
                        var n = t.reduce, s = (t = r.getFbeventsModules("SignalsFBEventsUtils")).isSafeInteger,
                            o = function (e) {
                                function t() {
                        ...
                        var b = {
                            ...
                            }, array: c, arrayOf: function (e) {
                                return function (t) {
                                    return f(t, b.array()).map(e)
                                }
                            }, assert: p, boolean: function () {
                                return function (e) {
                        ...
                        i.exports = {Typed: b, coerce: g, enforce: f, FBEventsCoercionError: o}
                    }(), i.exports
                }()
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        var e = r.getFbeventsModules("SignalsFBEventsTyped");
                        e.coerce;
                        var t = e.enforce, n = e.FBEventsCoercionError;
                        e = {
                ...
                return function (e, t, n, r) {
                    ...
                    return s.exports, function () {
                        "use strict";
                        var e = Object.prototype.toString, n = !("addEventListener" in t);
                        ...
                        var c = Object.prototype.hasOwnProperty, g = !{toString: null}.propertyIsEnumerable("toString"),
                        ...
                        function v(e) {
                            ...
                            if (g) for (var r = 0; r < p; r++) c.call(e, f[r]) && t.push(f[r]);
                            return t
                        }
                        ...
                        function b(e) {
                            ...
                            for (var t = Object(this), n = t.length >>> 0, r = arguments.length >= 2 ? arguments[1] : void 0, s = 0; s < n; s++) if (s in t && e.call(r, t[s], s, t)) return !0;
                            return !1
                        }
                        ...
                        function m(e) {
                            ...
                            if ("function" != typeof e) throw new TypeError;
                            for (var r = [], s = arguments.length >= 2 ? arguments[1] : void 0, i = 0; i < n; i++) if (i in t) {
                                var o = t[i];
                        ...
                        var y = /^null | null$|^[^(]* null /i, _ = /^undefined | undefined$|^[^(]* undefined /i;
                        h.default = h;
                        var F = function () {
                            function e(t) {
                        ...
                        F = {
                            FBSet: F, castTo: function (e) {
                                return e
                            }, each: function (e, t) {
                                E.call(this, e, t)
                            }, filter: function (e, t) {
                                return m.call(e, t)
                            }, idx: h, isArray: r, isEmptyObject: function (e) {
                                return 0 === v(e).length
                            }, isInstanceOf: function (e, t) {
                                return null != t && e instanceof t
                            }, isInteger: l, isNumber: function (e) {
                                return "number" == typeof e || "string" == typeof e && /^\d+$/.test(e)
                            }, isObject: i, isPlainObject: function (e) {
                            ...
                            }, keys: v, listenOnce: function (e, t, r) {
                                var s = n ? "on" + t : t;
                            ...
                            }, map: E, reduce: function (e, t, n) {
                                if (null == e) throw new TypeError(" array is null or not defined");
                                if ("function" != typeof t) throw new TypeError(t + " is not a function");
                                var r = Object(e), s = r.length >>> 0, i = 0;
                                if (null != n) n = n; else {
                                    for (; i < s && !(i in r);) i++;
                ...
                return function (e, t, n, s) {
                    ...
                    return i.exports, function () {
                        "use strict";
                        var e = r.getFbeventsModules("SignalsFBEventsBaseEvent"),
                            t = r.getFbeventsModules("SignalsFBEventsTyped"), n = t.coerce, s = t.Typed,
                        ...
                        var i = function () {
                            ...
                            return o(s, [{
                                key: "containsKey", value: function (e) {
                                    for (var t = 0; t < this._params.length; t++) if (this._params[t].name === e) return !0;
                                    return !1
                                }
                            }, {
                                key: "get", value: function (e) {
                                    e = e;
                                    for (var t = 0; t < this._params.length; t++) if (this._params[t].name === e) return this._params[t].value;
                                    return null
                                }
                            }, {
                                ...
                                key: "replaceEntry", value: function (e, t) {
                                    this._removeKey(e), this.append(e, t)
                                }
                            }, {
                                key: "addRange", value: function (e) {
                                    var n = this;
                                    e.each((function (e, r) {
                                        return n._append({name: e, value: r}, t, !1)
                                    }))
                                }
                            }, {
                                key: "append", value: function (t, n) {
                                    var r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                                    return this._append({name: encodeURIComponent(t), value: n}, e, r), this
                                }
                            }, {
                                key: "appendHash", value: function (t) {
                                    var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                                ...
                                key: "_translateValue", value: function (e, t, n) {
                                ...
                                key: "_appendPrimitive", value: function (e, t, n) {
                                ...
                                key: "_appendObject", value: function (e, n, r) {
                                    var s = null;
                                    for (var i in n) if (Object.prototype.hasOwnProperty.call(n, i)) {
                                        var o = e + "[" + encodeURIComponent(i) + "]";
                                        try {
                                            this._append({name: o, value: n[i]}, t, r)
                                        } catch (e) {
                                            null == s && (s = e)
                                        }
                                    }
                                ...
                                key: "fromHash", value: function (e, t) {
...
}(window, document, location, history), function (e, t, n, r) {
    var s, i = {exports: {}};
    i.exports, (s = e.fbq).execStart = e.performance && e.performance.now && e.performance.now(), function () {
        var t = e.postMessage || function () {
        };
        return !!s || (t({
            action: "FB_LOG",
        ...
        return function (e, t, n, r) {
            ...
            return i.exports, function () {
                ...
                var n = s.getFbeventsModules("SignalsFBEventsIWLBootStrapEvent"),
                    ...
                    l = s.getFbeventsModules("signalsFBEventsGetTier"), c = r.logUserError,
                    d = /^https:\/\/.*\.facebook\.com$/i, g = "FACEBOOK_IWL_CONFIG_STORAGE_KEY",
                ...
                i.exports = new a((function (r, s) {
                    ...
                    function v() {
                        if (!a) {
                            var t = f.getItem(g);
                            if (t) {
                                var n = (t = JSON.parse(t)).pixelID, r = t.graphToken, s = t.sessionStartTime;
                                a = !0, i(n, (function () {
                                    var t = p(n) ? n : null;
                    ...
                    function b(e, t, n) {
                        f.setItem(g, JSON.stringify({graphToken: e, pixelID: t, sessionStartTime: n})), v()
                    }
                    ...
                    n.listen((function (t) {
                        ...
                        var t = e.data, n = t.graphToken, r = t.msg_type, i = t.pixelID;
    ...
    i.exports, (s = e.fbq).execStart = e.performance && e.performance.now && e.performance.now(), function () {
        ...
        return function (e, t, n, r) {
            ...
            return i.exports, function () {
                "use strict";
                var t = s.getFbeventsModules("SignalsFBEventsEvents"), n = t.getCustomParameters, r = t.piiAutomatched,
                    o = t.piiConflicting, a = t.piiInvalidated,
                ...
                var l = s.getFbeventsModules("SignalsFBEventsProxyState"),
                    c = s.getFbeventsModules("SignalsFBEventsUtils"), d = c.some, g = !1;
                ...
                function b() {
                    ...
                    return !!(e.external && e.external.toString && e.external.toString().indexOf("Sequentum") >= 0) || !!(t.documentElement && t.documentElement.getAttribute && (t = d(["selenium", "webdriver", "driver"], (function (t) {
                ...
                function y() {
                    ...
                    return {hasDetectionFailed: n, isHeadless: t, isSelenium: e}
                }
                ...
                (c = new t((function (e, t) {
                    if (!g) {
                        ...
                        r.listen((function (e) {
                            ...
                            var a = p(!0 !== e.disableConfigLoading, u.CONFIG_LOADING), d = p(function () {
                                    try {
                                    ...
                                    return !0
                                }(), u.SUPPORTS_DEFINE_PROPERTY), g = p(f(), u.SUPPORTS_SEND_BEACON),
                                v = p(null != n && i[n.id], u.HAS_CONFLICTING_PII),
                                E = p(null != n && s[n.id], u.HAS_INVALIDATED_PII);
                            n = p(null != n && c[n.id], u.HAS_AUTOMATCHED_PII);
                            var b = p(l.getShouldProxy(), u.SHOULD_PROXY), m = y();
                            return {o: o = o | r | a | d | g | E | b | m.isHeadless | m.isSelenium | m.hasDetectionFailed | v | n}
                        })), g = !0
                    }
                ...
                return function (e, t, n, r) {
                    ...
                    return s.exports, function () {
                        ...
                        var c = l.getFbeventsModules("SignalsFBEventsNetworkConfig"),
                            d = l.getFbeventsModules("SignalsFBEventsQE"), g = l.getFbeventsModules("SignalsParamList"),
                            ...
                            B = l.getFbeventsModules("SignalsFBEventsTyped"), P = B.coerce, O = B.Typed, T = p.each;
                        B = p.FBSet;
                        var w = p.isEmptyObject, A = p.isPlainObject, N = p.isNumber, C = p.keys;
                        p = I.execEnd;
                        var k, R = I.fired, D = I.getCustomParameters, L = I.iwlBootstrap, j = I.piiInvalidated,
                            U = I.setIWLExtractors, G = I.validateCustomParameters, H = I.validateUrlParameters,
                            V = v.logError, W = v.logUserError, q = h.global, K = -1,
                            X = "b68919aff001d8366249403a2544fba2d833084f1ad22839b6310aadacb6a138",
                            Q = Array.prototype.slice, J = Object.prototype.hasOwnProperty, z = n.href, Y = !1, $ = !1,
                            Z = [], ee = {};
                        t.referrer;
                        var te = {PageView: new B, PixelInitialized: new B}, ne = new b(l, ee), re = new x(ne, q),
                            se = new B(["eid"]);
                        ...
                        function oe() {
                            try {
                                ...
                                var t = S(e), n = [].concat(u(t.args)), r = t.isLegacySyntax, s = n.shift();
                                switch (s) {
                                    case"addPixelId":
                                        Y = !0, ue.apply(this, n);
                                        break;
                                    ...
                                    case"send":
                                        ...
                                        break;
                                    case"on":
                                        var i = a(n), c = i[0], d = i.slice(1), g = I[c];
                                        g && g.triggerWeakly(d);
                                        break;
                                    case"loadPlugin":
                                        re.loadPlugin(n[0]);
                        ...
                        function ae(e) {
                            ...
                            switch (e) {
                                ...
                                case"releaseSegment":
                                    ...
                                    break;
                                case"autoConfig":
                                    var u = n[0], g = n[1], f = !0 === u || "true" === u ? "optIn" : "optOut";
                                    if ("string" != typeof g) {
                                        W({
                                ...
                                case"firstPartyCookies":
                                    var p = n[0], v = n[1], b = !0 === p || "true" === p ? "optIn" : "optOut";
                                ...
                                case"iwlExtractors":
                                    var F = n[0], S = n[1];
                                    U.triggerWeakly({extractors: S, pixelID: F});
                                    break;
                                case"startIWLBootstrap":
                                    var x = n[0], M = n[1];
                                    L.triggerWeakly({graphToken: x, pixelID: M});
                                    break;
                                case"parallelfire":
                                    var I = n[0], B = n[1];
                                    ne.pluginConfig.set(I, "parallelfire", {target: B});
                                    break;
                                case"pcmInstagramTriggerAttribution":
                                    var T = n[0];
                                    ne.pluginConfig.set(T, "pcmInstagramTriggerAttribution", {pcmInstagramTriggerAttributionURL: c.INSTAGRAM_TRIGGER_ATTRIBUTION});
                                    break;
                                case"trackSingleOnly":
                                    var w = n[0], A = n[1], N = P(w, O.boolean()), C = P(A, O.fbid());
                                    if (null == C) {
                                        W({
                                            invalidParamName: "pixel_id",
                                            invalidParamValue: A,
                                ...
                                default:
                                    var R = ne.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                                        D = null != R && R.dataProcessingOptions.includes("LDU"), j = n[0], G = n[1];
                        ...
                        function ce(e, t, n) {
                            if ((r = E.validateMetadata(e)).error && W(r.error), r.warnings && r.warnings.forEach((function (e) {
                                ...
                                for (var r = 0, s = Z.length; r < s; r++) if (Z[r].id === n) {
                                    Z[r][e] = t;
                                    break
                                }
                            } else W({metadataValue: t, pixelID: n, type: "SET_METADATA_ON_UNINITIALIZED_PIXEL_ID"})
                        }
                        ...
                        function fe(e, t) {
                            be({customData: t, eventName: e, pixel: null})
                        }

                        function pe(e, t, n) {
                            Z.forEach((function (n) {
                                return be({customData: t, eventName: e, pixel: n})
                            }))
                        }
                        ...
                        function Ee(e, t, n, r) {
                            ...
                            try {
                                var o = e && e.userData || {}, a = e && e.userDataFormFields || {}, u = {}, c = {},
                                    d = void 0;
                        ...
                        function be(e) {
                            var r = e.customData, s = e.eventData, i = e.eventName;
                            if (null != (e = e.pixel) && y.pixelHasActiveBridge(e)) y.sendEvent(e, i, r || {}); else {
                                var o = Ee(e, i, r);
                                if (null != s) {
                                    var a = s.eventID;
                        ...
                        function ye() {
                            return {pixelInitializationTime: K, pixels: Z}
                        }
                        ...
                        l._initHandlers = [], l._initsDone = {}, q.onUnlocked((function () {
                            me()
                        })), l.pixelId && (Y = !0, ue(l.pixelId)), (Y && $ || e.fbq !== e._fbq) && W({type: "CONFLICTING_VERSIONS"}), Z.length > 1 && W({type: "MULTIPLE_PIXELS"}), R.listenOnce((function () {
                            (function () {
                                if (!0 !== l.disablePushState && r.pushState && r.replaceState) {
                                    var t = F((function () {
                                        if (k = z, (z = n.href) !== k) {
                                            var e = new ie({allowDuplicatePageViews: !0});
                                ...
                                e.persisted && (e = new ie({allowDuplicatePageViews: !0}), oe.call(e, "trackCustom", "PageView"))
                            }))
                        })), _e(e.fbq), me(), s.exports = {doExport: _e}, p.trigger()
                    }(), s.exports
                }(e, t, n, r)
    ...
    plugin: function (e, t, n) {
        e.loadPlugin("commonincludes"), e.loadPlugin("opttracking"), e.set("experiments", [{
            ...
            batchWaitTimeMs: 501,
            maxBatchSize: 10
        }), n.set(null, "microdata", {waitTimeMs: 500}), t.configLoaded("global_config")
    }
});